...
EQUIPOS_MOCK = {
    ...
    "coleg": {
        ...
        "formaciones_disponibles": ["4-4-2", "4-3-3"],
        "jugadores": [
            JugadorTactico(id="coleg_1", nombre="Miguel Martínez", posicion="POR", numero=1, rating=6.5, x=0.5, y=0.95),
            JugadorTactico(id="coleg_2", nombre="Raúl Torres", posicion="LD", numero=2, rating=6.4, x=0.85, y=0.75),
            JugadorTactico(id="coleg_3", nombre="Fabio Ramos", posicion="DFC", numero=3, rating=6.6, x=0.65, y=0.8),
            JugadorTactico(id="coleg_4", nombre="Carlos Benítez", posicion="DFC", numero=4, rating=6.5, x=0.35, y=0.8),
            JugadorTactico(id="coleg_5", nombre="Pedro López", posicion="LI", numero=6, rating=6.3, x=0.15, y=0.75),
            JugadorTactico(id="coleg_6", nombre="Óscar Gamarra", posicion="MC", numero=5, rating=6.7, x=0.7, y=0.55),
            ...
            JugadorTactico(id="coleg_10", nombre="Lucas Fernández", posicion="DC", numero=9, rating=6.8, x=0.55, y=0.25),
            JugadorTactico(id="coleg_11", nombre="Matías Olmedo", posicion="DC", numero=10, rating=6.7, x=0.45, y=0.25),
        ],
        ...
        "ultimos_partidos": [
            ...
            PartidoResumen(fecha="2026-06-15", rival="Guaraní", resultado="1-2", formacion="4-4-2"),
    ...
    "gcab": {
        ...
        "formaciones_disponibles": ["4-3-3", "4-4-2"],
        "jugadores": [
            JugadorTactico(id="gcab_1", nombre="Alfredo Martínez", posicion="POR", numero=1, rating=6.4, x=0.5, y=0.95),
            ...
            JugadorTactico(id="gcab_4", nombre="Víctor Medina", posicion="DFC", numero=4, rating=6.4, x=0.35, y=0.8),
            JugadorTactico(id="gcab_5", nombre="Eduardo Fleitas", posicion="LI", numero=6, rating=6.2, x=0.15, y=0.75),
            JugadorTactico(id="gcab_6", nombre="Hugo Benítez", posicion="MC", numero=5, rating=6.6, x=0.65, y=0.55),
            JugadorTactico(id="gcab_7", nombre="Raúl Oviedo", posicion="MC", numero=8, rating=6.5, x=0.5, y=0.6),
            ...
            JugadorTactico(id="gcab_11", nombre="Sergio Ramírez", posicion="EI", numero=11, rating=6.4, x=0.15, y=0.35),
        ],
        ...
        "ultimos_partidos": [
            ...
            PartidoResumen(fecha="2026-06-22", rival="Sol de América", resultado="2-0", formacion="4-3-3"),
            PartidoResumen(fecha="2026-06-15", rival="General Díaz", resultado="0-1", formacion="4-4-2"),
        ],
    },
    "rubio": {
        "nombre": "Rubio Ñu",
        ...
        "jugadores": [
            ...
            JugadorTactico(id="rubio_2", nombre="Marcos González", posicion="LD", numero=2, rating=6.4, x=0.85, y=0.75),
            JugadorTactico(id="rubio_3", nombre="Pedro Delgado", posicion="DFC", numero=3, rating=6.6, x=0.65, y=0.8),
            JugadorTactico(id="rubio_4", nombre="Ángel Vera", posicion="DFC", numero=4, rating=6.5, x=0.35, y=0.8),
            ...
            JugadorTactico(id="rubio_7", nombre="Raúl Ortíz", posicion="MC", numero=5, rating=6.7, x=0.65, y=0.55),
            JugadorTactico(id="rubio_8", nombre="César Benegas", posicion="MC", numero=8, rating=6.6, x=0.35, y=0.55),
            JugadorTactico(id="rubio_9", nombre="Fernando Álvarez", posicion="MI", numero=11, rating=6.5, x=0.15, y=0.5),
    ...
    "2mayo": {
        ...
        "formaciones_disponibles": ["4-3-3", "4-4-2"],
        "jugadores": [
            JugadorTactico(id="2mayo_1", nombre="Roberto Pérez", posicion="POR", numero=1, rating=6.6, x=0.5, y=0.95),
            ...
            JugadorTactico(id="2mayo_8", nombre="Raúl Romero", posicion="MC", numero=10, rating=6.9, x=0.35, y=0.55),
            JugadorTactico(id="2mayo_9", nombre="Brian Benítez", posicion="ED", numero=7, rating=6.7, x=0.85, y=0.35),
            JugadorTactico(id="2mayo_10", nombre="Nelson Segovia", posicion="DC", numero=9, rating=7.0, x=0.5, y=0.25),
            JugadorTactico(id="2mayo_11", nombre="Arnaldo Velázquez", posicion="EI", numero=11, rating=6.6, x=0.15, y=0.35),
        ],
    ...
    "sanlor": {
        ...
        "jugadores": [
            JugadorTactico(id="sanlor_1", nombre="Carlos Arévalos", posicion="POR", numero=1, rating=6.3, x=0.5, y=0.95),
            JugadorTactico(id="sanlor_2", nombre="Roberto Cabrera", posicion="LD", numero=2, rating=6.2, x=0.85, y=0.75),
            JugadorTactico(id="sanlor_3", nombre="José Ortigoza", posicion="DFC", numero=3, rating=6.4, x=0.65, y=0.8),
            JugadorTactico(id="sanlor_4", nombre="Francisco Barrios", posicion="DFC", numero=4, rating=6.3, x=0.35, y=0.8),
            JugadorTactico(id="sanlor_5", nombre="Raúl Servín", posicion="LI", numero=6, rating=6.1, x=0.15, y=0.75),
            JugadorTactico(id="sanlor_6", nombre="Diego Martínez", posicion="MC", numero=5, rating=6.5, x=0.7, y=0.55),
            JugadorTactico(id="sanlor_7", nombre="Ángel González", posicion="MC", numero=8, rating=6.4, x=0.3, y=0.55),
            JugadorTactico(id="sanlor_8", nombre="Sergio Fernández", posicion="MD", numero=7, rating=6.3, x=0.85, y=0.4),
            JugadorTactico(id="sanlor_9", nombre="Pedro Amarilla", posicion="MI", numero=11, rating=6.2, x=0.15, y=0.4),
            JugadorTactico(id="sanlor_10", nombre="Lucas Quiñónez", posicion="DC", numero=9, rating=6.6, x=0.55, y=0.25),
        ...
        "ultimos_partidos": [
            ...
            PartidoResumen(fecha="2026-06-08", rival="Rubio Ñu", resultado="0-0", formacion="5-3-2"),
        ],
    },
    "stri": {
        ...
        "jugadores": [
            ...
            JugadorTactico(id="stri_3", nombre="Raúl Martínez", posicion="DFC", numero=3, rating=6.8, x=0.65, y=0.8),
            ...
            JugadorTactico(id="stri_8", nombre="Raúl Torres", posicion="MC", numero=8, rating=6.7, x=0.35, y=0.55),
            ...
            JugadorTactico(id="stri_11", nombre="Arnaldo González", posicion="DC", numero=10, rating=6.8, x=0.45, y=0.25),
        ],
    ...
    "tembet": {
        ...
        "formaciones_disponibles": ["5-3-2", "4-4-2", "3-5-2"],
        "jugadores": [
            JugadorTactico(id="tembet_1", nombre="Juan González", posicion="POR", numero=1, rating=6.4, x=0.5, y=0.95),
            ...
            JugadorTactico(id="tembet_4", nombre="Carlos Benítez", posicion="DFC", numero=4, rating=6.4, x=0.5, y=0.82),
            JugadorTactico(id="tembet_5", nombre="Raúl Benítez", posicion="DFC", numero=5, rating=6.3, x=0.3, y=0.8),
            JugadorTactico(id="tembet_6", nombre="Sergio Amarilla", posicion="DFI", numero=6, rating=6.2, x=0.1, y=0.75),
            JugadorTactico(id="tembet_7", nombre="Diego González", posicion="MC", numero=7, rating=6.6, x=0.65, y=0.55),
            JugadorTactico(id="tembet_8", nombre="Jorge Martínez", posicion="MC", numero=8, rating=6.5, x=0.5, y=0.6),
        ...
        "ultimos_partidos": [
            ...
            PartidoResumen(fecha="2026-06-15", rival="General Díaz", resultado="0-0", formacion="5-3-2"),
            PartidoResumen(fecha="2026-06-08", rival="Deportivo Capiatá", resultado="1-1", formacion="4-4-2"),
        ],
    },
    "recol": {
        "nombre": "Recoleta FC",
        ...
        "formaciones_disponibles": ["4-3-3", "4-4-2"],
        "jugadores": [
            JugadorTactico(id="recol_1", nombre="Marcos Acuña", posicion="POR", numero=1, rating=6.7, x=0.5, y=0.95),
            JugadorTactico(id="recol_2", nombre="Santiago Amarilla", posicion="LD", numero=2, rating=6.6, x=0.85, y=0.75),
            JugadorTactico(id="recol_3", nombre="Raúl Martínez", posicion="DFC", numero=3, rating=6.8, x=0.65, y=0.8),
            ...
            JugadorTactico(id="recol_6", nombre="Diego Martínez Jr", posicion="MC", numero=5, rating=6.9, x=0.65, y=0.55),
            JugadorTactico(id="recol_7", nombre="Jorge Espinoza Jr", posicion="MC", numero=8, rating=6.8, x=0.5, y=0.6),
            JugadorTactico(id="recol_8", nombre="Raúl Torres Jr", posicion="MC", numero=10, rating=7.0, x=0.35, y=0.55),
            ...
            JugadorTactico(id="recol_11", nombre="Arnaldo González Jr", posicion="EI", numero=11, rating=6.7, x=0.15, y=0.35),
        ],
