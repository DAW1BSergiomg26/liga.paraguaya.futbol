_KEYWORDS: dict[str, list[str]] = {
    ...
    "match_result": ["ganó", "gano", "resultado", "cómo quedó", "como quedo", "último partido", "ultimo partido", "último clásico", "ultimo clasico", "pasó", "paso", "último resultado", "ultimo resultado", "últimos resultados", "ultimos resultados", "cómo viene", "como viene", "últimos partidos", "ultimos partidos", "marcha", "racha", "fecha"],
    ...
    "prediction": ["gana", "próximo", "proximo", "predicción", "prediccion", "pronóstico", "pronostico", "va a ganar", "quién gana", "quien gana", "va ganar"],
    ...
    "next_match": ["cuándo juega", "cuando juega", "próximo partido", "proximo partido", "próximo", "proximo", "horario", "fecha", "día juega", "dia juega", "se enfrenta", "próximos partidos", "proximos partidos", "partido de", "partidos de", "agenda"],
