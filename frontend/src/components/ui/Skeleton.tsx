            ...
            <tr key={r} className="border-b border-white/5">
              {Array.from({ length: cols }).map((_, c) => (
                <td key={c} className="p-4">
                  <div className="h-4 bg-white/5 rounded animate-pulse w-full" style={{ maxWidth: c === 1 ? "120px" : "40px" }} />
                </td>
              ))}
            </tr>
          ))}
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="p-6 rounded-xl border border-white/10 bg-[#0a1628]/60">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="p-6 rounded-xl bg-[#0a1628]/60 border border-white/5 text-center">
