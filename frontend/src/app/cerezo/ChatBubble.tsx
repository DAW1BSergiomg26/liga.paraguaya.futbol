    ...
    <div className={`flex ${role === "user" ? "justify-end" : "justify-start"}`}>
      ...
      <div
        className={`max-w-[80%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
          role === "user"
            ? "bg-py-rojo text-black rounded-br-md"
      ...
      {role === "user" && (
        <div className="w-8 h-8 rounded-full bg-py-rojo flex items-center justify-center text-black text-xs font-bold shrink-0 ml-2 mt-1">
          U
        </div>
      )}
    </div>
