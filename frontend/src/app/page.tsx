...
export default async function HomePage() {
  const [[clubes, errClubes], [partidosData, errPartidos], [tabla, errTabla]] = await Promise.all([
    safeFetch(() => getClubes(), []),
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <section className="mb-12 p-8 rounded-2xl border border-white/10 bg-[#0a1628]/80 shadow-xl">
        ...
        {hasErrors ? (
          <div className="inline-flex items-center gap-2 mt-6 px-4 py-2 rounded-full bg-red-900/30 text-red-300 border border-red-500/30 text-sm">
            <span className="w-2.5 h-2.5 rounded-full bg-red-400 shadow-lg shadow-red-400/50" />
      ...
      {/* Error banners */}
      {errClubes && (
        <div className="mb-4 px-4 py-3 rounded-lg bg-red-900/20 border border-red-500/30 text-red-300 text-sm">
